<div class="card content-wrap auto-height mt-l">
    ...
    @if(count($backups) > 0)
        <div class="item-list " style=" max-height: 28rem; overflow-y: auto;">
                    ...
                    <div class="flex px-m py-xs">
                        ...
                        @elseif(isset($backup['sha256']))
                            <div component="dropdown" class="dropdown-container">
                                <button refs="dropdown@toggle" type="button" class="button outline small icon" aria-haspopup="true" aria-expanded="false" aria-label="{{ trans('bookstack-backup::settings.history_show_hash') }}" title="{{ trans('bookstack-backup::settings.history_show_hash') }}">@icon('info')</button>
